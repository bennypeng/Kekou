...
class Blueprint
{
    ...
    {
        $this->timestamp('created_at', $precision)->nullable()->useCurrent()->comment('创建时间');
        $this->timestamp('updated_at', $precision)->nullable()->default(\DB::raw('CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'))->comment('更新时间');
    }
